              ...
              return(     
                <SwiperSlide>            
                 <div className='max-w-3xl m-auto py-20 pb-20'>
                     <div className='text-center flex justify-center	py-4 max-w-xs	m-auto'> <img  src={testimonalimg1.src} /></div>
                     ...
                     <div className='text-center flex justify-center items-center gap-3 py-4'>
                            <div className=''> <img  src={testimonalimg2.src} alt=" testimonalimg"/></div>
