...
const Platformtab = () => {
  ...
  return (
    <section id='platform'>
      ...
      <div className='py-10'>
        <div className='section-title max-w-3xl	m-auto' style={{margin:"auto"}}>
        ...
        <div className="">
          <Tabs  value={1} className="m-auto text-sm active">
            <div className="max-w-3xl m-auto py-5" style={{margin:"auto"}}>
              <TabsHeader className="text-sm capitalize	 content-between m-auto" style={{justifyContent:"center"}}>
                {faq.map((item, index) => {
                        ...
                        <div className="">
                          <div className="grid grid-cols-1 gap-4 pt-10 py-10 w-90 items-end items-center md:grid-cols-2">
                            <div className="text-center md:text-left sm:text-center lg:text-left">
                              <div className="text-lg text-green-900 font-semibold">{i.attributes.name}</div>
                              ...
                              <div className="text-base font-medium pt-4 text-green-900">Learn more about how we're changing the world →</div>
                            </div>
                            <div className="">
                              <div className="">
                                <img src={tabimg1.src} alt='tab-img'/>
                              </div>
                            </div>
                          </div>
                        </div>
